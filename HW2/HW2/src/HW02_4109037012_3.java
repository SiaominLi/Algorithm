...
//better and mergesort
public class HW02_4109037012_3 extends FourSum {
	
	public static void main(String[] args) {
		
		HW02_4109037012_3 test = new HW02_4109037012_3();		
...
//        
		...
		for ( int i = 0 ; i < len-3 && orderedArr[i] < 0 ; i++ ) {
			for ( int j = i+1 ; j < len - 2 && orderedArr[i] + orderedArr[j] < 0 ; j++ ){
